...
public class CustomerProductPOJO {
	...
	public CustomerProductPOJO(String dop, String serial_number, String imei1, String imei2, String popurl,
		...
		super();
		this.dop = dop;
		if (verifyImei(serial_number) && verifyImei(imei1) && verifyImei(imei2)) {
			this.serial_number = serial_number;
			this.imei1 = imei1;
			this.imei2 = imei2;
		} else {
			System.out.println("IMEI length should 14 characters");
		}
		this.popurl = popurl;
	...
	private boolean verifyImei(String data) {
		if (data.length() == 14) {
			return true;
		} else {
			return false;
